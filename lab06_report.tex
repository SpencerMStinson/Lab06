...
One of my main errors was in naming. I consistently had an input or output name slightly different than it was meant to be. This caused me many problems and also caused my Basys board not to run correctly originally. 
...
\begin{figure}
	\includegraphics{basys2.jpg}
\caption{Basys board running 7 segment }\label{fig:Basys}
\end{figure}
\begin{figure}
	\includegraphics{Basys1.jpg}
\caption{Basys board running 7 segment }\label{fig:Basys}
\section*{Code}
\end{figure}
...
\Verilog{mux4_2b.sv}
\Verilog{mux4_2b_testbench.sv}
\Verilog{sseg_decoder.sv}
\Verilog{sseg_decoder_testbench.sv}
\Verilog{sseg1_.sv}
\Verilog{sseg_wrapper.sv}
\Verilog{sseg_1_testbench.sv}
\end{document}
